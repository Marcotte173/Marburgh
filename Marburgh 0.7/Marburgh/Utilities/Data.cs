...
public class Data
{
    ...
    public static void Save(Creature p)
    {
        ...
        {
            sw.WriteLine($"{p.family.LastName},{p.pClass.cName},{p.potions},{p.Weapon.name},{p.Armor.name},{p.gold},{p.bankGold},{p.damage},{p.energy},{p.maxEnergy},{p.health},{p.maxHealth},{p.level},{p.levelMax},{p.magic},{p.maxMagic},{p.xp},{Time.day}");
        }
